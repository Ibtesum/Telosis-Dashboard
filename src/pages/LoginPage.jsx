...
// import { Logo } from "../assets/img/telosis.svg";
            ...
            <section className="py-6 w-full max-w-xl">
              ...
              <header className="mb-10 text-center">
                <h1 className="text-2xl font-bold inline-flex items-center mb-2 space-x-2">
                  ...
                  {/* <Logo /> */}
                  {/* <svg src={Logo} /> */}
                  <img src="../assets/img/telosis.svg" alt="" />
                  {/* <svg
                    className="hi-mini hi-cube-transparent inline-block w-5 h-5 text-rose-600 dark:text-rose-500"
                  ...
                  <form className="space-y-6">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full block border placeholder-gray-500 px-5 py-3 leading-6 rounded-lg border-gray-200 focus:border-rose-500 focus:ring focus:ring-rose-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-rose-500 dark:placeholder-gray-400"
                      />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div>
                      {/* <div className="flex items-center justify-between space-x-2 mb-5">
                        <label className="flex items-center">
                          <input
                            ...
                            id="remember_me"
                            name="remember_me"
                            className="border border-gray-200 rounded h-4 w-4 text-rose-500 focus:border-rose-500 focus:ring focus:ring-rose-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:ring-offset-gray-900 dark:focus:border-rose-500 dark:checked:bg-rose-500 dark:checked:border-transparent"
                          />
                          <span className="text-sm ml-2">Remember me</span>
                        </label>
                        <Link
                          to="/"
                          className="text-sm font-medium inline-block text-rose-600 hover:text-rose-400 dark:text-rose-400 dark:hover:text-rose-300"
                        >
                          Forgot Password?
                        </Link>
                      </div> */}
                      ...
                      {/* <div className="grid grid-cols-2 gap-2">
                        ...
                        >
                          <svg
                            className="bi bi-facebook inline-block w-4 h-4 text-[#1877f2]"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor"
                            viewBox="0 0 16 16"
                            aria-hidden="true"
